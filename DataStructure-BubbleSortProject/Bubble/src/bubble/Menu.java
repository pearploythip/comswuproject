...
public class Menu {
	...
	private void initialize() {
		...
		Sound sound = new Sound("C:\\Users\\Pl0y\\Desktop\\sound.wav");
		sound.play();
		
		
		JLabel bg = new JLabel("");
		bg.setBounds(90, 88, 400, 300);
		...
		btnplay.setIcon(new ImageIcon("C:\\Users\\Pl0y\\Desktop\\music.png"));
		btnplay.setBounds(10, 497, 57, 53);
		btnplay.setOpaque(false);
		btnplay.setContentAreaFilled(false);
		btnplay.setBorderPainted(false);
		btnplay.setFocusPainted(false);
		frmBubblesortproject.getContentPane().add(btnplay);
		...
		btnstop.setIcon(new ImageIcon("C:\\Users\\Pl0y\\Desktop\\stop.png"));
		btnstop.setOpaque(false);
		btnstop.setFocusPainted(false);
		btnstop.setContentAreaFilled(false);
		btnstop.setBorderPainted(false);
		btnstop.setBounds(77, 497, 57, 53);
		frmBubblesortproject.getContentPane().add(btnstop);
