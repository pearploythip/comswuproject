        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                case 2:
                	  for (int index = 0; index < values.length; index++) {
                		  int num ;
                		  String input = JOptionPane.showInputDialog(null, "Input your number ." +"\n|"+ (index+1)+"|");
                		  try { 
    ...
    public class SortPane extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (int index = 0; index < values.length; index++) {
                ...
                g2d.drawString(value+"", x+25, colWidth+570);//เพิ่มเติม
               // g.drawImage(new ImageIcon("D:/FFOutput/1l.gif").getImage(), x, height - colHeight, this);
                if (getSorter().isActiveIndex(index) && highlight != null) {
                    ...
                    g2d.drawString(value+"", x+25, colWidth +570);//สีแดง
